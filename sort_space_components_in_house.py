...
class Ship_Component:
    ...
    def store_loot_in_hopper(self, item_coords, hopper_type):
        ...
        swg_utils.click_drag(item_coords, into_hopper_coords, num_drags=1, start_delay=0.0, return_delay=0.75)
...
def put_junk_into_caravan(backpack_coords=None):
    ...
    while not done:
        ...
        for i in range(num_items_to_move_from_hopper_to_caravan):
            ...
            swg_utils.click_drag(item_coords, into_inventory_coords, num_drags=1, start_delay=0.0, return_delay=0.5)
        # Close hopper
        pdi.press('esc')
...
num_items_in_bulky_containers = 12
num_pit_droids = 22
pit_droid_pane = 6
